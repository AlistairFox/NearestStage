...
//			return false;
//
//		if (ps->testFlag(GAME_PLAYER_MP_INPUT_CAR))
	//		return true;
	//	else
	//		return false;
	//}
...
void CCar::OnEvent(NET_Packet& P, u16 type)
{
	...
	case GE_OWNERSHIP_REJECT:
	{
		...
		if (GetInventory()->DropItem(smart_cast<CGameObject*>(O), just_before_destroy, just_before_destroy))
		{
