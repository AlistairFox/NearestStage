...
void ShowHudEditor(bool& show)
{
	...
	if (item)
	{
		...
		ImGui::InputFloat3("fire_point 0", (float*)&item->m_measures.m_fire_point_offset[0], 3);
		ImGui::InputFloat3("fire_point2 0", (float*)&item->m_measures.m_fire_point2_offset[0], 3);
		ImGui::InputFloat3("shell_point 0", (float*)&item->m_measures.m_shell_point_offset[0], 3);
		ImGui::InputFloat3("hud_collision_offset_pos 0", (float*)&item->m_measures.m_collision_offset[0]);
		ImGui::InputFloat3("hud_collision_offset_rot 0", (float*)&item->m_measures.m_collision_offset[1]);
		ImGui::InputFloat3("safemode_offset_pos 0", (float*)&item->m_measures.m_safemodeoffset[0]);
		ImGui::InputFloat3("safemode_offset_rot 0", (float*)&item->m_measures.m_safemodeoffset[1]);
	...
	if (item)
	{
		...
		ImGui::InputFloat3("fire_point 1", (float*)&item->m_measures.m_fire_point_offset[0], 3);
		ImGui::InputFloat3("fire_point2 1", (float*)&item->m_measures.m_fire_point2_offset[0], 3);
		ImGui::InputFloat3("shell_point 1", (float*)&item->m_measures.m_shell_point_offset[0], 3);
		ImGui::InputFloat3("hud_collision_offset_pos 1", (float*)&item->m_measures.m_collision_offset[0]);
		ImGui::InputFloat3("hud_collision_offset_rot 1", (float*)&item->m_measures.m_collision_offset[1]);
		ImGui::InputFloat3("safemode_offset_pos 1", (float*)&item->m_measures.m_safemodeoffset[0]);
		ImGui::InputFloat3("safemode_offset_rot 1", (float*)&item->m_measures.m_safemodeoffset[1]);
