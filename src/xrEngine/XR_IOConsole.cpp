...
static u32 const prompt_font_color  = color_rgba( 76, 255, 0, 255 );
static u32 const tips_font_color    = color_rgba( 200, 200, 200, 255 );
static u32 const cmd_font_color     = color_rgba( 76, 255, 0, 255 );
static u32 const cursor_font_color  = color_rgba( 255, 255, 255, 255 );
static u32 const total_font_color   = color_rgba( 200, 200,  200, 180 );
static u32 const default_font_color = color_rgba( 250, 250, 250, 250 );

static u32 const back_color         = color_rgba(  0,  0,  0, 200 );
static u32 const tips_back_color    = color_rgba(  0,  0,  0, 200 );
static u32 const tips_select_color  = color_rgba(  140,  140, 140, 230 );
static u32 const tips_word_color    = color_rgba(   76, 255,  0, 200 );
static u32 const tips_scroll_back_color  = color_rgba( 0, 0, 0, 230 );
...
u32 CConsole::get_mark_color( Console_mark type )
{
	...
	case mark2:  color = color_rgba( 76, 255, 0, 255 ); break;
	case mark3:  color = color_rgba( 76, 222, 0, 155 ); break;
	case mark4:  color = color_rgba( 255,   255, 0, 255 ); break;
	case mark5:  color = color_rgba( 76,  155, 0, 155 ); break;
	...
	case mark10: color = color_rgba(  182, 255, 0, 255 ); break;
	case mark11: color = color_rgba( 205, 205, 105, 255 ); break;
	case mark12: color = color_rgba( 0, 255, 13, 255 ); break;
	case no_mark:
	default: break;
	}
	return color;
