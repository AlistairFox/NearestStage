...
{
public:
	CCC_Gamma	(LPCSTR N, float* V) : CCC_Float(N,V,0.5f,1.01f)	{}
...
ENGINE_API float	sv_object_shedule_scale = 0.0f;
...
//	CMD4(CCC_Integer,	"rs_ib_size",			&rsDIB_Size,		32,		4096);
	...
	CMD4(CCC_Float, "sv_object_shedule_scale", &sv_object_shedule_scale, 0.0f, 5.0f);
