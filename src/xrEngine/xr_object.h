...
class	NET_Packet	;
class	CSE_Abstract;
extern ENGINE_API float sv_object_shedule_scale;
...
public:
	...
	virtual float						shedule_Scale()							{ return sv_object_shedule_scale; /*Device.vCameraPosition.distance_to(Position()) / 200.f;*/ }
