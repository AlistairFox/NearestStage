...
//#ifdef RUSSIAN_BUILD
		u32	trivial_encryptor::m_table_iterations = 4 * 1024; //4*1024;
		u32	trivial_encryptor::m_table_seed = 7089984; //7071984;
		u32	trivial_encryptor::m_encrypt_seed		= 25631979; //24031979;
//#else // RUSSIAN_BUILD
