...
enum EGamePlayerFlags
{
	...
	GAME_PLAYER_MP_NO_UNLIMATED_AMMO	= (1<<12),
	GAME_PLAYER_MP_SAVE_LOADED			= (1<<13),

	GAME_PLAYER_MP_ANIMATION_MODE = (1 << 14),
	GAME_PLAYER_MP_SAFE_MODE = (1 << 15),
	GAME_PLAYER_MP_WOUND_MODE = (1 << 16),
	GAME_PLAYER_MP_INPUT_CAR = (1<< 17),
