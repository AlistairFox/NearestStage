...
CScriptIniFile* create_ini(LPCSTR path, LPCSTR ini_file, bool load)
{
	return xr_new<CScriptIniFile>(path, ini_file, false, load);
}

CScriptIniFile* read_ini(LPCSTR path, LPCSTR ini_file, bool load)
{
	return xr_new<CScriptIniFile>(path, ini_file, true, load);
}
